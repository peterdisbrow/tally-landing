...
export const translations = {
  en: {
    ...
    'hero.proof': '25 integrations · Automatic recovery · AI natural language control · Self-service church portal',
  ...
  es: {
    ...
    'hero.proof': '25 integraciones · Recuperación automática · Control por lenguaje natural con IA · Portal de iglesia',
