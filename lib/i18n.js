...
export const translations = {
  en: {
    ...
    'hero.proof': '23 integrations · Automatic recovery · AI natural language control · Self-service church portal',
  ...
  es: {
    ...
    'hero.proof': '23 integraciones · Recuperación automática · Control por lenguaje natural con IA · Portal de iglesia',
