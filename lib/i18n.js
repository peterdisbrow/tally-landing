...
export const translations = {
  en: {
    ...
    'hero.proof': 'Works with 23+ devices (tier-dependent) · Automatic recovery · AI natural language control · Self-service church portal',
    ...
    'signup.subtitle': '30-day free trial.',
    ...
    'signup.field.billing.annual': 'Annual (billed yearly)',
  ...
  es: {
    ...
    'hero.proof': 'Compatible con 23+ dispositivos (según el plan) · Recuperación automática · Control por lenguaje natural con IA · Portal de iglesia',
    'hero.cta_primary': 'Empieza Gratis — 30 Días →',
    'hero.cta_secondary': 'Ver la Aplicación ↓',

    // Problem section
    'problem.title': 'El Pánico del Domingo por la Mañana es Real',
    'problem.subtitle': 'Todo equipo de producción de iglesia conoce ese momento.',
    ...
    'signup.subtitle': 'Prueba gratuita de 30 días.',
    ...
    'signup.field.billing.annual': 'Anual (facturado por año)',
    ...
    'signin.error.invalid': 'Correo electrónico o contraseña incorrectos',
    ...
    'portal.overview.preservice': 'Chequeo Pre-Servicio',
    'portal.overview.preservice.all_clear': 'Todo en orden',
    'portal.overview.preservice.issues': '{{n}} problema(s)',
    'portal.overview.preservice.run_now': 'Checar ahora',
    'portal.overview.preservice.fix': 'Corregir lo que sea seguro',
    ...
    'portal.tds.invite_copied': '¡Enlace copiado! Mándaselo a tu DT — cuando lo abran, quedan registrados solos.',
    'portal.tds.role': 'Rol',
    ...
    'portal.schedule.sub': 'Define los horarios de tus servicios para que las alertas funcionen bien',

    // Email template strings
    'email.trial_7days.subject': 'Tu prueba de Tally termina en {{n}} días — esto es lo que dejarías de tener',
    ...
    'error.session_expired': 'Tu sesión expiró. Vuelve a iniciar sesión.',
  },
};
