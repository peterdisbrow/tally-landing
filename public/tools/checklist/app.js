...
function showScreen(screen) {
  [welcomeScreen, builderScreen, checklistScreen].forEach(s => s.classList.add("hidden"));
...
<div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:16px;border-bottom:1px solid ${border};margin-bottom:24px">
  <div>
    <span style="font-weight:800;font-size:18px;color:${txt}">Tally</span><span style="font-weight:800;font-size:18px;color:${accent}">Connect</span>
