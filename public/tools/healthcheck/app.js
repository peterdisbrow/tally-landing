...
const GRADES = [
  { min: 90, grade: "A+", label: "Production Fortress", color: "#22c55e", badgeClass: "" },
  { min: 75, grade: "B",  label: "Solid Foundation",    color: "#22c55e", badgeClass: "" },
  { min: 60, grade: "C",  label: "Room to Grow",        color: "#eab308", badgeClass: "badge--yellow" },
  { min: 40, grade: "D",  label: "At Risk",             color: "#f97316", badgeClass: "badge--orange" },
  { min: 0,  grade: "F",  label: "Flying Blind",        color: "#ef4444", badgeClass: "badge--red" },
];
...
<div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:20px;border-bottom:1px solid ${border};margin-bottom:32px">
  <div>
    <span style="font-weight:800;font-size:18px;color:${text}">Tally</span><span style="font-weight:800;font-size:18px;color:${accent}">Connect</span>
