export const metadata = {
  ...
  description:
    'Tu transmisión se cayó. Tally ya lo arregló. Monitoreo con recuperación automática para equipos de producción de iglesia. Compatible con 23+ dispositivos. Prueba gratuita.',
  ...
  openGraph: {
    title: 'Tally | Monitoreo y Recuperación Automática para Iglesias',
    description:
      'Tu transmisión se cayó. Tally ya lo arregló. Recuperación automática de transmisión, monitoreo de producción y control con IA para equipos de iglesia. Compatible con 23+ dispositivos (según el plan). 30 días gratis.',
