export const metadata = {
  ...
  description:
    'Your stream crashed. Tally already fixed it. Auto-recovery monitoring for church production teams. Works with 23+ devices. Free trial.',
  ...
  openGraph: {
    title: 'Tally | Church Streaming Auto-Recovery & Production Monitoring',
    description:
      'Your stream crashed. Tally already fixed it. Automatic stream recovery, production monitoring, and AI-powered control for church tech teams. Works with 23+ devices (tier-dependent). Free 30-day trial.',
