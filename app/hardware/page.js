...
const CATEGORIES = [
  ...
  },
  {
    ...
    devices: [
      ...
      { name: 'Teradek', features: ['HTTP Status Monitoring', 'Bitrate Polling', 'Auto-recovery'], minVersion: 'VidiU Go / Cube', notes: 'Basic HTTP status checks and bitrate polling.' },
      { name: 'YoloBox', features: ['HTTP Status Monitoring', 'Auto-recovery'], minVersion: 'YoloBox Pro', notes: 'Basic status monitoring via network API.' },
      { name: 'Epiphan', features: ['HTTP Status Monitoring', 'Recording Status', 'Auto-recovery'], minVersion: 'Pearl / Pearl Mini', notes: 'HTTP API status checks for streaming and recording state.' },
      { name: 'AJA HELO', features: ['HTTP Status Monitoring', 'Recording Status', 'Auto-recovery'], minVersion: 'Firmware 3.0+', notes: 'Basic HTTP status polling for streaming and recording state.' },
      { name: 'Blackmagic Web Presenter', features: ['Status Monitoring'], minVersion: 'Web Presenter HD', notes: 'Basic streaming status via Blackmagic SDK.' },
    ],
  },
  {
    id: 'presentation',
  ...
  },
  {
    ...
    devices: [
      ...
      { name: 'Allen & Heath SQ', features: ['Fader Control', 'Mute/Solo', 'Scene Recall', 'Monitoring'], minVersion: 'Firmware 1.5+', notes: 'Control via Bitfocus Companion integration. Scene recall and channel control.' },
      { name: 'Allen & Heath dLive', features: ['Fader Control', 'Mute/Solo', 'Scene Recall', 'Monitoring'], minVersion: 'Firmware 1.9+', notes: 'Control via Bitfocus Companion integration for large-format consoles.' },
